...
class LoginReq : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:bean.LoginReq) */ {
 public:
  LoginReq();
  virtual ~LoginReq();
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_LoginReq_2eproto_impl();
...
// optional int64 telephone = 1;
inline void LoginReq::clear_telephone() {
  telephone_ = GOOGLE_LONGLONG(0);
}
inline ::google::protobuf::int64 LoginReq::telephone() const {
  // @@protoc_insertion_point(field_get:bean.LoginReq.telephone)
  return telephone_;
}
inline void LoginReq::set_telephone(::google::protobuf::int64 value) {
